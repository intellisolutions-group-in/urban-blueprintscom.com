...
import { servicesData, ServiceSection, ServiceSectionItem } from "@/data/services";
import { Container } from "@/components/layout/Container";
import { CheckCircle2, ArrowRight, MapPin, ChevronDown, ChevronUp, X, Phone, Mail, Clock, Send, ShieldCheck, Cpu } from "lucide-react";
...
function SectionRenderer({ section, index }: { section: ServiceSection, index: number }) {
  ...
  return (
    <section className="mb-20">
      ...
      {/* SECTION 3 - KEY SERVICES / TOPICS (Text Image Grid to Responsive Card Grid Rebuild) */}
...
export default function ServiceDetailsPage({ params }: PageProps) {
  ...
  const fullWidthSections = service.sections?.filter(s => s.type === 'accordion' || s.type === 'list-block') || [];

  const mainSections = service.sections?.filter(s => 
    ...
    <main className="min-h-screen bg-background overflow-x-hidden">
      <AnimatePresence mode="wait">
        {isPageLoading ? (
          ...
          >
            {/* =========================================================================
               SECTION 1 — HERO AREA (Completely Redesigned & Rebuilt)
               ========================================================================= */}
            <header className="relative w-full aspect-video md:aspect-[21/9] lg:aspect-[3/1] min-h-[420px] flex items-center overflow-hidden bg-[#0a1224] text-white">
              ...
              <div className="absolute inset-0 z-0 bg-[#0a1224]">
                ...
                {/* Soft, modern overlay to keep the full image bright and clear while ensuring readable text */}
            ...
            {/* =========================================================================
               SECTION 2 — INTRODUCTION (Redesigned Split Layout)
               ========================================================================= */}
            <section id="overview" className="py-20 lg:py-24 relative">
              <Container>
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                  ...
                  {/* Right Column (Sidebar Quick Fact Sheet) */}
            ...
            {/* =========================================================================
               SECTION 3 & 4 & 5 — DYNAMIC PAGE CONTENT
               ========================================================================= */}
            <section className="pb-16 relative">
              <Container>
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                  {/* Main Sections (Key Services Grid, Text Blocks) */}
                  <div className="lg:col-span-8">
                  ...
                  <div className="lg:col-span-4">
                    <aside className="space-y-8 sticky top-32 lg:pt-[72px]">
                      ...
                      {/* Sidebar Conclusion / Career Sections */}
                      {sidebarSections.map((section, index) => (
                        <div key={index} className="space-y-6 pt-8">
                          <h4 className="font-heading font-bold text-lg text-primary uppercase tracking-wider mb-4 pb-2 border-b border-border/50">{section.title}</h4>
            ...
            {/* Accordions & Bullet Lists (SECTION 4 & 5) */}
                ...
                <Container>
                  <div className="max-w-4xl mx-auto">
                    {fullWidthSections.map((section, index) => (
                      <SectionRenderer key={index} section={section} index={mainSections.length + index} />
                    ))}
                  </div>
                </Container>
              </section>
            ...
            {/* Case Study Details Modal Overlay Trigger */}
            ...
            {/* =========================================================================
               SECTION 7 — RELATED SERVICES (Stunning three-column Grid Rebuild)
               ========================================================================= */}
            ...
            {/* =========================================================================
               SECTION 6 — BOTTOM CALL TO ACTION (CAD Coordinates Blueprint)
               ========================================================================= */}
            ...
            {/* =========================================================================
               SECTION 8 — PRE-FOOTER FINAL CONTACT BANNER
               ========================================================================= */}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                  ...
                  <div className="lg:col-span-7 space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4">
                      {[
                        { icon: Phone, label: 'Call Principal Desk', val: '(968) 432-4578' },
                        { icon: Mail, label: 'Email Desk', val: 'info@urbanblueprints.com' },
                        { icon: MapPin, label: 'Main Office Laboratory', val: '505 North State Street, London, UK' },
                  ...
                  {/* Right Column: Coordinate Map visual banner */}
